...
//             <article
//               key={item.id}
//               className="group bg-bg rounded-2xl p-6 shadow-md hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border border-border"
//             >
//               <div className="flex items-start gap-4">
//                 <div className="flex-none rounded-lg bg-btn-dark text-btn-dark-text p-3 shadow-sm group-hover:scale-105 transition-transform">
//                   {item.icon}
//                 </div>
